  ...
  return (
    ...
    >
      <div className=" h-full flex flex-col md:flex-row gap-12 justify-center items-center  max-w-lg-screen mx-auto">
        <div className="flex flex-col gap-8  max-w-xl   text-cyan-600 text-justify">
          <h1 className="text-5xl xl:text-6xl max-w-lg border-b-[1px] border-teal-400 pb-4">
            <span className="text-sky-300">AA</span> ENGINEERING
          </h1>
          <p className="text-cyan-600 text-lg max-w-md ">
        ...
        <div className="max-w-xl text-cyan-600">
